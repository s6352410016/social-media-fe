...
const Following = ({ setOpenFollowingPopup, showProfilePageStatus, setShowProfilePageStatus, userIdToFollower, userInfo, userData, followAndUnFollow, setFollowAndUnFollow }) => {
